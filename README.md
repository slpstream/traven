<p align="center">
  <img src="assets/traven-wordmark.svg" alt="Traven Wordmark" width="450">
</p>
...
*   🖼️ **Optimistic Media Uploads**: Drag and drop or paste image files directly into the editor. The view immediately embeds an optimistic spinner loader and replaces it with the final URL once your upload handler resolves.
*   🎨 **Decoupled Styling (Skins)**: Theme aesthetics (colors, padding, borders) are decoupled from the JavaScript logic. Swap between a slate **Neutral Skin** and a bold **Colorful Skin** by changing a single `<link>` stylesheet, with no rebuilding required.
