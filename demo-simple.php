...
/**
 * demo-simple.php
 * A minimal, out-of-the-box Traven Editor integration demo.
 */
...
<head>
    ...
    <title>Traven Editor — Out-of-the-Box Simple Demo</title>
...
<body>
    ...
    <main>
        <h1 id="demo-page-title">Traven — Simple Out-of-the-Box Demo</h1>
        <p class="lead">
            This page mounts the default custom element <code>&lt;traven-editor&gt;</code> inside a standard HTML form.
        </p>
        ...
        <form id="simple-editor-form" class="editor-form" action="" method="POST">
            ...
            <traven-editor id="traven-default-instance" name="body" toolbar><?php echo htmlspecialchars($submittedContent); ?></traven-editor>
