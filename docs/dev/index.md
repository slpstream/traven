# Traven Editor — Developer Documentation

This area is for developers who want to extend, customize, or contribute to the Traven Editor codebase itself. It covers the build system, internal architecture, theming, shortcodes, and rendering internals.
...
- **[Customization & Styling](customization-styling.md)** — How to swap between pre-built skins (light, dark, colorful, editorial, modern, academic, custom) and toolbar stylesheets, load skins via CDN, and hide or re-style toolbar buttons using CSS selectors.
