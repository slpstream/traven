...
3. The toolbar itself can be expanded to a full-length feature set of 30+ buttons, or collapsed to show just the most frequently-used tools.
...
Think of this page as an interactive sandbox, so use all the toys in the toolbar to play around and see the power of a fast, unobtrusive Markdown editor that you can add to any website.`;
