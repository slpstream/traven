...
export class TravenEditor {
     ...
     */
    getListExpandTargets(): (arg0: string) => Promise<{
        summary?: string | null;
        deck?: string | null;
        headings: {
            title: string;
...
export type TravenOptions = {
    ...
    /**
     * - Optional richer Expand/Embed target picker: return frontmatter summary and/or deck (if any) plus section headings. When set, the expand-embed modal offers Whole post | Summary | Deck | sections.
     */
    onListExpandTargets?: (arg0: string) => Promise<{
        summary?: string | null;
        deck?: string | null;
        headings: {
            title: string;
